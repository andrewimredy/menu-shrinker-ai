...
class _$ChatImpl extends _Chat {
  const _$ChatImpl(
      {required this.id, this.duration = const Duration(minutes: 5)})
      : super._();
  ...
  @override
  String toString() {
    return 'Chat(id: $id, duration: $duration)';
  }
...
abstract class _Chat extends Chat {
  const factory _Chat({required final String id, final Duration duration}) =
      _$ChatImpl;

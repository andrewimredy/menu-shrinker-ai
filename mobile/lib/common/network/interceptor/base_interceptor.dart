...
class BaseInterceptor extends Interceptor {
  BaseInterceptor({required this.deviceInfoProvider, required this.requestIdProvider, required this.config});
  ...
  void onRequest(RequestOptions options, RequestInterceptorHandler handler) {
    ...
    options.headers[AppHttpHeaders.authorization] = 'Bearer ${config.aiApiKey}';
    options.headers[AppHttpHeaders.requestId] = requestIdProvider.nextUniqueRequestId;
